...
<script src="/ZZMSCMS/App/Manage/View/Public/js/frame.js?v201625" language="javascript" type="text/javascript"></script>
<script type="text/javascript" src="/ZZMSCMS/Data/static/jq_plugins/layer/layer.js"></script>
<link href="/ZZMSCMS/App/Manage/View/Public/css/frame.css" rel="stylesheet" type="text/css" />

<!--[if IE 6]>
<script src="/ZZMSCMS/App/Manage/View/Public/js/DD_belatedPNG_0.0.8a-min.js" language="javascript" type="text/javascript"></script>
<script>
...
<div class="head">
<div class="top_logo" style="line-height: 60px;text-align: center;color:white;font-size: 22px;">
    <!--<img src="/ZZMSCMS/App/Manage/View/Public/images/main/logo.png" /> -->
    <span>PowerBY:DaWenXi</span>
</div>
