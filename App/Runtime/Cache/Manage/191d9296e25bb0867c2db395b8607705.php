...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/uploads_code/xyhai.php?s=/Model';
	    var APP	 = '/uploads_code/xyhai.php?s=';
	    var SELF='/uploads_code/xyhai.php?s=/Model/edit/id/1';
		...
		<div class="col-lg-12">
				...
				<form method='post' class="form-horizontal" id="form_do" name="form_do" action="<?php echo U('edit');?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="tablename" id="inputTablename" value="<?php echo ($vo["tablename"]); ?>" class="form-control" placeholder="表名小写，去掉默认表前缀" required="required" />
