...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/uploads_code/xyhai.php?s=/Personal';
	    var APP	 = '/uploads_code/xyhai.php?s=';
	    var SELF='/uploads_code/xyhai.php?s=/Personal/index';
		...
		<div class="col-lg-12">
				...
				<form method='post' class="form-horizontal" id="form_do" name="form_do" action="<?php echo U('index');?>">					
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<p class="form-control-static"><?php echo (date('Y-m-d H:i:s',$vo["logintime"])); ?></p>		
						</div>
					</div>				
					<div class="form-group">
						<label for="inputName" class="col-sm-2 control-label">最后登录IP</label>
						<div class="col-sm-9">
							<p class="form-control-static"><?php echo ($vo["loginip"]); ?></p>		
						</div>
					</div>
