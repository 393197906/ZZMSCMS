...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/uploads_code/admin.php?s=/Category';
	    var APP	 = '/uploads_code/admin.php?s=';
	    var SELF='/uploads_code/admin.php?s=/Category/add';
					...
					<div class="tab-content" style="margin-top:20px;">
						<div role="tabpanel" class="tab-pane active" id="home">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									    <input type="text" class="form-control" name="catpic" id="litpic"  value="" placeholder="栏目图片地址" />	
								</div>
								<div class="col-sm-5">
