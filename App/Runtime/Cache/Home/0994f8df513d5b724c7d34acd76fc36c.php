...
<div class="form">
		<form method='post' id="form_do" name="form_do" action="<?php echo U(MODULE_NAME. '/Public/login');?>">
		<dl>
			<dt>邮箱：</dt>
			<dd>
		...
		<?php if(C('CFG_VERIFY_LOGIN') == 1): ?><dl>
			<dt>验证码</dt>
			<dd>
				<input type="text" name="vcode" class="inp_small" /><img src="/uploads_code/index.php?s=/Public/verify.html" id="VCode" onclick="javascript:changeVcode(this);" />
			</dd>
		</dl><?php endif; ?>

		<div class="form_b">		
			<input type="submit" class="btn_blue" id="submit" value="登录">
			<a href="<?php echo U(MODULE_NAME. '/Public/register');?>" class="btn_blue">注册</a>
